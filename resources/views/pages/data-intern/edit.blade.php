    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        */
        ...
        function openEditModal(data) {
            ...
            const form = $('#submitFormEditKampus');
            form.attr('action', `/data-intern/${data.pr_id}/update`);
            // Fill form fields with existing data
            fform.find('input[name="pr_nama"]').val(data.pr_nama);
            form.find('input[name="pr_no_hp"]').val(data.pr_no_hp);
            form.find('textarea[name="pr_alamat"]').val(data.pr_alamat);
            form.find('select[name="pr_jenis_kelamin"]').val(data.pr_jenis_kelamin);
            form.find('input[name="pr_nim"]').val(data.pr_nim);
            form.find('select[name="pr_kampus_id"]').val(data.pr_kampus_id);
            form.find('input[name="pr_jurusan"]').val(data.pr_jurusan);
            form.find('input[name="pr_internship_start"]').val(data.pr_internship_start);
            form.find('input[name="pr_internship_end"]').val(data.pr_internship_end);
            form.find('input[name="pr_supervisor_name"]').val(data.pr_supervisor_name);
            form.find('input[name="pr_supervisor_contact"]').val(data.pr_supervisor_contact);
