<div id="eventModal" class="fixed inset-0 z-999999 hidden p-5 overflow-y-auto" role="dialog" aria-modal="true">
    ...
    <div class="min-h-full flex items-center justify-center">
        <div class="relative w-full max-w-[700px] rounded-3xl bg-white p-6 lg:p-11 ">
            ...
            <form id="submitFormTeknologi" class="flex flex-col gap-6" action="{{ route('teknologi.store') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div>
                    <h5 id="eventModalLabel" class="font-semibold text-gray-800 text-xl dark:text-white">
                        Tambah Data Teknologi
                    </h5>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Silahkan isi form berikut untuk menambahkan master data teknologi baru.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input id="event-title" type="text"
                        ...
                        placeholder="Contoh: Laravel, React, PostgreSQL..." name="tk_nama">
                ...
                <div class="flex justify-end gap-3 pt-4">
                    ...
                    <button type="button" id="btnSimpanTeknologi"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function resetTeknologiForm() {
            const form = $('#submitFormTeknologi');
            form[0].reset();
        ...
        |--------------------------------------------------------------------------
        */
        $('#btnSimpanTeknologi').on('click', function (e) {
            e.preventDefault();
            const form = $('#submitFormTeknologi');
