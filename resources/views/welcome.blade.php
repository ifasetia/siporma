...
<body class="antialiased bg-gray-50 text-gray-800 font-sans">
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8" data-aos="fade-up">
                <div class="p-8 rounded-3xl bg-gray-50 border border-gray-100 hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">Terhubung dengan berbagai Perguruan Tinggi yang
                        bekerja sama dengan Dinas Kominfo dalam program pengembangan SDM.</p>
                </div>
                <div class="p-8 rounded-3xl bg-gray-50 border border-gray-100 hover:shadow-xl transition">
                    <div class="w-12 h-12 bg-blue-100 text-blue-600 rounded-2xl flex items-center justify-center mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                ...
                <div class="p-8 rounded-3xl bg-gray-50 border border-gray-100 hover:shadow-xl transition">
                    <div class="w-12 h-12 bg-blue-100 text-blue-600 rounded-2xl flex items-center justify-center mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.040L3 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622l-.382-3.040z" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold mb-3">Monitoring Terintegrasi</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">Proses pengerjaan dipantau langsung oleh mentor
                        dinas guna memastikan kualitas dan progres tercapai tepat waktu.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid md:grid-cols-4 gap-8 relative" data-aos="fade-up">
                <div class="flex flex-col items-center">
                    <div
                        class="w-16 h-16 bg-blue-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-6 z-10 shadow-lg shadow-blue-200">
                        1</div>
        ...
        <div class="max-w-3xl mx-auto px-6">
            ...
            <div class="space-y-6">
                <div class="p-6 rounded-2xl bg-gray-50 border border-gray-100" data-aos="fade-up">
                    ...
                    <p class="text-gray-600 text-sm">Hanya mahasiswa yang datanya sudah didaftarkan secara resmi oleh
                        Super Admin Dinas Kominfo.</p>
                </div>

                <div class="p-6 rounded-2xl bg-gray-50 border border-gray-100" data-aos="fade-up">
                    <h4 class="font-bold text-gray-900 mb-2">Bagaimana cara melaporkan kendala sistem?</h4>
                    <p class="text-gray-600 text-sm">Silakan hubungi Mentor masing-masing atau datang langsung ke ruang
                        Admin IT Kominfo.</p>
                </div>
            </div>
        </div>
    ...
    <footer class="bg-gray-900 py-12 text-white">
        <div class="max-w-7xl mx-auto px-6 text-center border-t border-gray-800 pt-8">
            <p class="text-sm text-gray-500">&copy; 2026 Siporma-app | Dinas Kominfo dan Statistik. Dibuat dengan
                dedikasi mahasiswa magang.</p>
        </div>
    </footer>
