...
class DatainternController extends Controller
{
    ...
    public function index()
    {
        ...
        $supervisor = Supervisor::all(); // ← TAMBAHKAN
        $pekerjaan = Pekerjaan::all(); // ← TAMBAHKAN
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $data = $request->validate([
                ...
                'pr_internship_start' => 'required',
                'pr_internship_end' => 'required',
                'pr_supervisor_id' => 'required',
                'pr_pekerjaan_id' => 'required',
                ...
                'pr_internship_start.required' => 'Tanggal mulai wajib diisi',
                'pr_internship_end.required' => 'Tanggal selesai wajib diisi',
                'pr_supervisor_id.required' => 'Supervisor wajib dipilih',
                'pr_pekerjaan_id.required' => 'Pekerjaan wajib dipilih',
            ]);
            ...
            $user->profile->update([
                'pr_js_id' => $data['pr_jurusan_id'],
                'pr_km_id' => $data['pr_kampus_id'],
                'pr_sp_id' => $data['pr_supervisor_id'],
                'pr_id_pekerjaan' => $data['pr_pekerjaan_id'],
